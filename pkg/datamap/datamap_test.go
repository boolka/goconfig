...
func TestMapGetter(t *testing.T) {
	...
	if v, ok := datamap.GetByPath(m, "field1"); !ok || v != 1 {
		t.Fatal(v, ok)
	}
}
...
func TestNestedMapGetter(t *testing.T) {
	...
	if v, ok := datamap.GetByPath(m, "field1.field2.field3"); !ok || v != 1 {
		t.Fatal(v, ok)
	}
}
...
func TestEmptyMap(t *testing.T) {
	...
	if v, ok := datamap.GetByPath(m, "field1.field2.field3"); ok || v != nil {
		t.Fatal(v, ok)
	}
}
